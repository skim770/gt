...
public class Mail extends Activity{
	...
	WebView webView;
	String url = "http://mail.gatech.edu";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView = (WebView) findViewById(R.id.wvMail);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		case 0:
			Intent LoginIntent = new Intent(Mail.this, Login.class);
			startActivity(LoginIntent);
			return true;
		case 1:
			Intent aboutIntent = new Intent(Mail.this, About.class);
