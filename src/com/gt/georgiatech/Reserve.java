...
public class Reserve extends Activity{
	...
	WebView webView;
	String url = "https://www.gtevents.gatech.edu/virtualems/RoomRequest.aspx?data=ity3Dem%2byxxGFZTQvNr97%2f3YTgvbeh%2bU";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("GT Reservation");
		
		info = getSharedPreferences("loginInfo", MODE_PRIVATE);
		webView = (WebView) findViewById(R.id.wvReserve);
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		case 0:
			Intent LoginIntent = new Intent(Reserve.this, Login.class);
			startActivity(LoginIntent);
			return true;
		case 1:
			Intent aboutIntent = new Intent(Reserve.this, About.class);
